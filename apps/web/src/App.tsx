...
function CurateStep({ clips, notes, provenance, transcript, analysis, showFillers, plans, planning, planProgress, planMessage, planError, onPlan, onNext, sceneIndex, sceneIndexArtifactId, detectingScenes, sceneProgress, sceneMessage, sceneError, onDetectScenes, faceIndex, detectingFaces, faceProgress, faceMessage, faceError, onDetectFaces }: { clips: SuggestedClip[]; notes: string; provenance?: SuggestionSelection["provenance"]; transcript: TranscriptDocument | null; analysis: AnalysisDocument | null; showFillers: boolean; plans: Record<string, EditPlanDocument>; planning: boolean; planProgress: number; planMessage: string; planError: string | null; onPlan: (clips: SuggestedClip[]) => Promise<boolean>; onNext: (clips: SuggestedClip[]) => Promise<void>; sceneIndex: SceneIndexDocument | null; sceneIndexArtifactId: string | null; detectingScenes: boolean; sceneProgress: number; sceneMessage: string; sceneError: string | null; onDetectScenes: () => void; faceIndex: FaceIndexDocument | null; detectingFaces: boolean; faceProgress: number; faceMessage: string; faceError: string | null; onDetectFaces: () => void }) {
