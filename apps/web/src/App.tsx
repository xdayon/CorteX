...
function CurateStep({ clips, notes, transcript, analysis, plans, planning, planProgress, planMessage, planError, onPlan, onNext, sceneIndex, sceneIndexArtifactId, detectingScenes, sceneProgress, sceneMessage, sceneError, onDetectScenes, faceIndex, detectingFaces, faceProgress, faceMessage, faceError, onDetectFaces }: { clips: SuggestedClip[]; notes: string; transcript: TranscriptDocument | null; analysis: AnalysisDocument | null; plans: Record<string, EditPlanDocument>; planning: boolean; planProgress: number; planMessage: string; planError: string | null; onPlan: (clips: SuggestedClip[]) => Promise<boolean>; onNext: (clips: SuggestedClip[]) => Promise<void>; sceneIndex: SceneIndexDocument | null; sceneIndexArtifactId: string | null; detectingScenes: boolean; sceneProgress: number; sceneMessage: string; sceneError: string | null; onDetectScenes: () => void; faceIndex: FaceIndexDocument | null; detectingFaces: boolean; faceProgress: number; faceMessage: string; faceError: string | null; onDetectFaces: () => void }) {
