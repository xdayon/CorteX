            ...
            with _Spinner(f"Clip {i+1}/{len(clips)}: {clip['title'][:40]}...") as sp:
                try:
                    result = generate_clip(
                        ...
                        hook_text=clip.get("hook_text") or clip.get("title"),
                        pacing_profile=clip.get("pacing_profile", config.get("pacing_profile", "auto")),
                            ...
                            with _Spinner(f"Rendering: {f_clip['title'][:40]}..."):
                                try:
                                    new_result = generate_clip(
                                        ...
                                        hook_text=f_clip.get("hook_text") or f_clip.get("title"),
                                        pacing_profile=f_clip.get("pacing_profile", config.get("pacing_profile", "auto")),
                                        output_dir=output_dir,
                                        logo_path=config.get("logo_path") or None,
                                        outro_path=config.get("outro_path") or None,
                            ...
                            with _Spinner(f"Rendering: {nc['title'][:40]}..."):
                                try:
                                    new_result = generate_clip(
                                        ...
                                        hook_text=nc.get("hook_text") or nc.get("title"),
                                        pacing_profile=nc.get("pacing_profile", config.get("pacing_profile", "auto")),
                                        output_dir=output_dir,
                                        logo_path=config.get("logo_path") or None,
                                        outro_path=config.get("outro_path") or None,
